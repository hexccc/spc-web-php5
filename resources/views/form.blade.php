...
{{-- IN CASE OF EMERGENCY INFORMATIONS --}}
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" class="form-control" name="lessor_lname" placeholder="Last Name">
    </div>
    <div class="form-group col-md-4 mt-2">
      <label for="lname"></label>
      <input type="text" class="form-control" name="lessor_fname" placeholder="First Name">
    </div>
    <div class="form-group col-md-4 mt-2">
      <label for="lname"></label>
      <input type="text" class="form-control" name="lessor_mname" placeholder="Middle Name">
    </div>
    <div class="form-group col-md-12">
  ...
  <div class="form-row">
    <div class="form-group col-md-4">
      <label>Telephone/Mobile No.</label>
        <input class="form-control" type="tel" name="emergency_tel" placeholder="539-1234 / 09123456789">
    </div>
    <div class="form-group col-md-6">
      <label>Email Address</label>
        <input class="form-control" type="email" name="emergency_email" placeholder="Email Address">
    ...
    <div class="form-group col-md-2">
      <label>Monthly Rental</label>
        <input class="form-control" type="number" name="no_male" placeholder="">
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-4">
      ...
      <input type="text" class="form-control" name="lineof_business" placeholder="Name of Business">
    </div>
    <div class="form-group col-md-2">
      <label for='fname'>No. of Units</label>
      <input type="number" class="form-control" name="lineof_business" placeholder="">
    </div>
    <div class="form-group col-md-2">
      <label for='fname'>Capitalization</label>
      <input type="number" class="form-control" name="capital" placeholder="">
    </div>
    <div class="form-group col-md-2">
      <label for='fname'>Essential</label>
      <input type="number" class="form-control" name="essential" placeholder="">
    </div>
    <div class="form-group col-md-2">
      <label for='fname'>Non-Essential</label>
      <input type="number" class="form-control" name="non_essential" placeholder="">
    </div>
