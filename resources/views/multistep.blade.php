									...
									<form id="addnewbuss">
									     ...
									     <label class="form-check-label">
									       <input type="radio" class="form-check-input" value="0" name="app[entity]">No
											...
											<div class="form-group-inline mb-4">
											 ...
											 <textarea type="text" class="form-control" name="app[buss_specifyentity]" placeholder="Please Specify Entity" rows="2"></textarea>
										 	</div>
									  ...
									  <div class="form-group">
										...
										<div class="form-group">
									 	 ...
									 	 <input type="text" class="form-control" name="app[tax_president]" placeholder="Name of President/Treasurer of Corporation">
									  </div>
                ...
                <div class="ui-step-content">
									...
									<div class="form-row">
										<div class="form-group col-md-4">
											...
											<input type="text" class="form-control"  placeholder="Bdlg#/Street/Brgy/City" name="app[owner_postcode]">
											<!-- <textarea type="text" class="form-control" name="app[buss_address]" placeholder="Bdlg#/Street/Brgy/City" rows="2"></textarea> -->
										</div>
										<!-- NOTE: added field -->
										<div class="form-group col-md-4">
                ...
                <div class="ui-step-content">
							  ...
							  <div class="form-row mb-3 mt-3">
							    <div class="form-group col-md-3">
										...
										<select class="form-control addlinebuss1" name="bussactivity[bussactivity_linebuss]" id="addline1">
										...
										<div class="form-group col-md-3">
											<label for='fname'>Code of Business</label>
												<select class="form-control" name="new[busact_addcode]" id="addcode1">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <input type="text" class="form-control" name="app[subcategory]" placeholder="">
                    </div>
							    <div class="form-group col-md-2">
              ...
              <li data-step="3">
                <div class="ui-step-content">
									      ...
									      <div class="form-row">
												<div class="form-group col-md-3">
													<label >Line of Business</label>
													<select class="form-control addlinebuss" name="bussactivity[bussactivity_linebuss]" id="addline">
													<option selected value=" ">Line of Business</option>
													<?php
													$linebuss = array("Manufacturers", "Wholesalers, distributors, or dealers", "Retailers", "Food","Contractors","Banks and other financial institutions","Lease","Lessor of real property","Tobacco dealers","Dealers of Liquors","Amusement Places and Devices","Theater and Cinema","Other business");
													foreach($linebuss as $linebus){
                        ...
                        <div class="form-group col-md-2">
      							      <label >No. of Units</label>
      							      <input type="number" id="addunits" class="form-control" name="" placeholder="">
      							    </div>
												<div class="form-group col-md-2">
													<div class="md-form">
