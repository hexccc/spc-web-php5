...
<div class="mx-auto col-md-10 offset-md-1 pt-4" style="width:100%">
    <h3 class="text-white p-2 mt-4">
      History of City of San Pablo
    </h3>
    <div class="row">
        <div class="media mt-2 p-3">

              <img src="{{URL::asset('image/old_spc.jpg')}}" alt="SPC" height="150px" class="align-self-start mr-2">
              <div class="media-body">
                <h4 class="mt-0 font-weight-bold" style="color:3490DC;">History of San Pablo City</h4>
                  <p>
                  ...
                  Government was established with Inocente Martinez as Municipal President
  ...
  <p> In ancient times, San Pablo was known as the village of Sampalok.
        ...
        abundance. This upland realm became our hometown, San Pablo de los Montes.</p>
<hr/>
        <h5 class="mt-0 font-weight-bold" style="color:3490DC;">History of Sampalok Lake</h5>
        <p> Sampalok was a large and prospering village which had its own system of government
        and culture. Barangays already existed and each was headed by a chieftain who
        was also known as  Gatpuno. Foremost among them were Gat Paguil, Gat Sungayan,
        Gat Salakab and Gat Pulintan.  Cultural development was manifested in marriage
        patterns, religion and social groups. </p><p>
        ...
        with as evidenced by  ceramic pieces  that were unearthed and carbon-dated.</p>
<hr/>
<h5 class="mt-0 font-weight-bold" style="color:3490DC;">Spaniards Era</h5>
        <p>In search of gold the first Spanish troops under Captain Juan de Salcedo reached
        the upland realm of Sampalok in 1571 and immediately announced governance in
        the name of the king of Spain. Administration of its affairs was turned over to
      ...
      Fiesta was introduced as part of religious rituals.  Consequently,
        ...
        municipality with a gobernadorcillo or capitan as its head.</p>
<hr/>
<h5 class="mt-0 font-weight-bold" style="color:3490DC;">American Era</h5>
        <p>The subsequent defeat of the Spanish colonizers set the stage for another war – the
...
after taking Santa Cruz and Calamba earlier and routed the  local freedom fighters.</p><p>
...
Pablo.
  ...
  <hr/>
  <h5 class="mt-0 font-weight-bold" style="color:3490DC;">Japanese Era</h5>
          <p>In the morning of December 25, 1941 Japanese fighter planes dropped bombs in the city
