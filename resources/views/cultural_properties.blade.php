...
<div id="landmark" class="mx-auto col-md-10 offset-md-1 pt-4" style="width:100%;">
  ...
  <div class="row px-2">
      <div data-aos="fade-right" class="media float-right mt-2 p-2">
        <img  src="{{URL::asset('image/1 San Pablo Cathedral.jpg')}}" alt="SPC" width="250px" class="float-right mr-2">
    ...
    <br>
      <div data-aos="fade-left" class="media float-right mt-2 p-2 py-2">
        ...
        <img  src="{{URL::asset('image/farcon.jpg')}}" alt="SPC" width="250px" class="float-right mr-2">
      </div>

      <div data-aos="fade-right" class="media float-right mt-2 p-2">
        <img src="{{URL::asset('image/plaza1.jpg')}}" alt="SPC" width="250px" class="float-right mr-2">
        <div class="media-body">
      ...
      <div data-aos="fade-left" class="media float-right mt-2 p-2 py-2">
        ...
        <img  src="{{URL::asset('image/c_hall.jpg')}}" alt="SPC" width="250px" class="float-right mr-2">
      </div>

      <div data-aos="fade-right" class="media float-right mt-2 p-2">
        <img src="{{URL::asset('image/hagdangbato.png')}}" alt="SPC" width="250px" class="float-right mr-2">
        <div class="media-body">
      ...
      <div data-aos="fade-left" class="media col-12 float-right mt-2 p-2 py-2">
        <div class="media-body text-right pr-2">
        ...
        <img src="{{URL::asset('image/casa real.jpg')}}" alt="SPC" width="350px" class="float-right mr-2">
      </div>

      <div data-aos="fade-right" data-aos="fade-right" class="media float-right mt-2 p-2">
        <img src="{{URL::asset('image/central.jpg')}}" alt="SPC" width="250px" class="float-right mr-2">
        <div class="media-body">
      ...
      <div data-aos="fade-left" class="media col-12 float-right mt-2 p-2 py-2">
        ...
        <img src="{{URL::asset('image/prudencia.jpg')}}" alt="SPC" width="350px" class="float-right mr-2">
      </div>
    ...
    <div class="row px-2">
    <div data-aos="fade-right" class="media col-12 float-right mt-2 p-2">
        <img src="{{URL::asset('image/jose rizal.jpg')}}" alt="SPC"  width="250px" class="float-right mr-2">
        <div class="media-body">
...
The battle of Sta. Isabel Shrine was erected in November 22, 1979 to commemorate the event on the historic spot on November 22, 1944. Filipino-American Guerilla unit under Col. Gertrudo San Pedro valiantly fought the invading Japanese imperial Forces during WWII.
        ...
        <img  src="{{URL::asset('image/pinaglabanan.JPG')}}" alt="SPC" width="250px" class="float-right mr-2">
      </div>

      <div data-aos="fade-right" class="media col-12 float-right mt-2 p-2">
        <img src="{{URL::asset('image/7 Apolinario Mabini.JPG')}}" alt="SPC"  width="250px" class="float-right mr-2">
        <div class="media-body">
      ...
      <div data-aos="fade-left" class="media col-12 float-right mt-2 p-2 py-2">
        ...
        <img src="{{URL::asset('image/boni.jpg')}}" alt="SPC" width="250px" class="float-right mr-2">
      </div>


      <div data-aos="fade-right" class="media col-12 float-right mt-2 p-2">
        <img src="{{URL::asset('image/RAILROAD.jpg')}}" alt="SPC"  width="250px" class="float-right mr-2">
        <div class="media-body">
      ...
      <div data-aos="fade-left" class="media col-12 float-right mt-2 p-2 py-2">
        ...
        <img  src="{{URL::asset('image/17 Trece Martirez Shrine.JPG')}}" alt="SPC" width="250px" class="float-right mr-2">
      </div>
      <div data-aos="fade-right" class="media col-12 float-right mt-2 p-2">
        <img src="{{URL::asset('image/19 Guerilla Shrine in San Mateo.JPG')}}" alt="SPC"  width="250px" class="float-right mr-2">
        <div class="media-body">
      ...
      <div data-aos="fade-left" class="media col-12 float-right mt-2 p-2 py-2">
        ...
        <img src="{{URL::asset('image/Lina Building.jpg')}}" alt="SPC" width="250px" class="float-right mr-2">
      </div>

      <div data-aos="fade-right" class="media col-12 float-right mt-2 p-2">
        <img src="{{URL::asset('image/leonila park.jpg')}}" alt="SPC"  width="250px" class="float-right mr-2">
        <div class="media-body">
      ...
      <div data-aos="fade-left" class="media col-12 float-right mt-2 p-2 py-2">
        ...
        <img  src="{{URL::asset('image/franklin.jpg')}}" alt="SPC" width="250px" class="float-right mr-2">
      </div>
    </div>
